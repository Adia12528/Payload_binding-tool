...
os.system("pkg install git && pkg install wget")
print("Now your termux to date. & Is reay for installation of metasploit 6.")
time.sleep(5)
print("ready for metasploit-framework installation.")
